...
from data import database, preprocessing
...
# Import functions for model prediction
from models import etymology_model
...
if __name__ == '__main__':
    ...
    database.collect_data()  # Step 1: Data Collection
    preprocessing.process_data()  # Step 2: Data Preprocessing
    train_model.train()  # Step 3: Model Training
    runEtymoAgent()  # Launch GUI for user interaction